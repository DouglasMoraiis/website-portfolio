...
!(function (e, t) {
  ...
  function u(e) {
    ...
    return (u = function (e) {
      if (
        e === null ||
        ((a = e), Function.toString.call(a).indexOf('[native code]') === -1)
      )
        return e;
      let a;
  ...
  function m(e, t) {
    ...
    if (typeof e === 'string') {
      ...
      if (n.indexOf('<') >= 0 && n.indexOf('>') >= 0) {
        ...
        d.innerHTML = n;
        for (let p = 0; p < d.childNodes.length; p += 1)
  ...
  let y = {
    ...
    attr(e, t) {
      ...
      for (let a = 0; a < this.length; a += 1)
        if (arguments.length === 2) this[a].setAttribute(e, t);
          ...
          for (let i in e) (this[a][i] = e[i]), this[a].setAttribute(i, e[i]);
      return this;
    },
    removeAttr(e) {
    ...
    trigger() {
      ...
      for (let s = a[0].split(' '), r = a[1], n = 0; n < s.length; n += 1)
        for (let l = s[n], d = 0; d < this.length; d += 1) {
          let p = this[d];
          if (e.CustomEvent) {
            let c = new e.CustomEvent(l, {
              detail: r,
              bubbles: !0,
              cancelable: !0
            });
    ...
    offset() {
      if (this.length > 0) {
        var e = o();
            ...
            var s = t.body;
            var n = a.clientTop || s.clientTop || 0;
            var l = a.clientLeft || s.clientLeft || 0;
            var d = a === e ? e.scrollY : a.scrollTop;
            var p = a === e ? e.scrollX : a.scrollLeft;
      ...
      if (arguments.length === 1) {
        if (typeof e != 'string') {
          for (a = 0; a < this.length; a += 1)
            for (let s in e) this[a].style[s] = e[s];
          return this;
        }
        if (this[0])
    ...
    return (
      ...
      b ||
        (b = (function (e) {
          ...
          let r = t || i.navigator.userAgent;
          var n = { ios: !1, android: !1 };
          let l = i.screen.width;
          var d = i.screen.height;
          var p = r.match(/(Android);?[\s\/]+([\d.]+)?/);
          var c = r.match(/(iPad).*OS\s([\d_]+)/);
          var u = r.match(/(iPod)(.*OS\s([\d_]+))?/);
          let h = !c && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
          var v = s === 'Win32';
          let f = s === 'MacIntel';
          return (
            !c &&
          ...
          if (!(!s.isTouchEvent && 'button' in d && d.button > 0))
            if (!s.isTouched || !s.isMoved)
              if (
                ...
                const c = l.currentX;
                var u = l.currentY;
                let h = n.edgeSwipeDetection || n.iOSEdgeSwipeDetection;
                let v = n.edgeSwipeThreshold || n.iOSEdgeSwipeThreshold;
  ...
  function D(e) {
    ...
    if ((l.originalEvent && (l = l.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || l.type === 'touchmove') {
        ...
        var p = l.type === 'touchmove' ? d.pageX : l.pageX;
        let c = l.type === 'touchmove' ? d.pageY : l.pageY;
        ...
        if (
          ...
          var h = n.currentY - n.startY;
          if (
            !(
              a.params.threshold &&
              Math.sqrt(u ** 2 + h ** 2) < a.params.threshold
            )
          ) {
            let v;
                  ...
                  ? ((g = !1),
                    s.resistance &&
                      (i.currentTranslate =
                        a.minTranslate() -
                        1 +
                        (-a.minTranslate() + i.startTranslate + f) ** b))
                  : f < 0 &&
                    ...
                    s.resistance &&
                      (i.currentTranslate =
                        a.maxTranslate() +
                        1 -
                        (a.maxTranslate() - i.startTranslate - f) ** b)),
    ...
    if (
      ...
      if (i.freeMode) {
        ...
        if (i.freeModeMomentum) {
          ...
          var T;
          let S = !1;
          let C = 20 * Math.abs(t.velocity) * i.freeModeMomentumBounceRatio;
          if (w < t.maxTranslate())
          ...
          if (
            ...
            if (
              ...
              var k = t.slidesSizesGrid[t.activeIndex];
  ...
  var V = {
    ...
    update: {
      ...
      updateSlides: function () {
        let e = this;
            ...
            var o = e.wrongRTL;
            var l = e.virtual && i.virtual.enabled;
            var d = l ? e.virtual.slides.length : e.slides.length;
            var p = s.children('.' + e.params.slideClass);
            var c = l ? e.virtual.slides.length : p.length;
            var u = [];
            var h = [];
            var v = [];
        ...
        if (void 0 !== r) {
          ...
          for (
            ...
            if (i.slidesPerColumn > 1) {
              ...
              if (i.slidesPerColumnFill === 'row' && i.slidesPerGroup > 1) {
                var G = Math.floor(I / (i.slidesPerGroup * i.slidesPerColumn));
                    var B = I - i.slidesPerColumn * i.slidesPerGroup * G;
                    var H =
                    G === 0
                      ? i.slidesPerGroup
                      : Math.min(
                ...
                (A =
                  (D = B - (N = Math.floor(B / H)) * H + G * i.slidesPerGroup) +
                  (N * T) / k),
                  O.css({
            ...
            if (O.css('display') !== 'none') {
              if (i.slidesPerView === 'auto') {
                let X = getComputedStyle(O[0]);
                    var Y = O[0].style.transform;
                    var R = O[0].style.webkitTransform;
                if (
                  ...
                  let V = a(X, 'width');
                      var W = a(X, 'padding-left');
                      var F = a(X, 'padding-right');
                      var _ = a(X, 'margin-left');
                      var q = a(X, 'margin-right');
                      var j = X.getPropertyValue('box-sizing');
          ...
          if ((u.length === 0 && (u = [0]), i.spaceBetween !== 0)) {
            var te;
                var ae = e.isHorizontal() && n ? 'marginLeft' : t('marginRight');
    ...
    translate: {
      ...
      translateTo: function (e, t, a, i, s) {
        ...
        if (
          ...
          if (t === 0) o[u ? 'scrollLeft' : 'scrollTop'] = -l;
          else if (o.scrollTo)
            o.scrollTo(
    ...
    slide: {
      slideTo: function (e, t, a, i) {
        ...
        let v = Math.min(r.params.slidesPerGroupSkip, n);
        ...
        if ((r.updateProgress(g), o.normalizeSlideIndex))
          for (let b = 0; b < d.length; b += 1) {
            var w = -Math.floor(100 * g);
                var y = Math.floor(100 * d[b]);
                var E = Math.floor(100 * d[b + 1]);
            void 0 !== d[b + 1]
              ? w >= y && w < E - (E - y) / 2
                ? (n = b)
                : w >= y && w < E && (n = b + 1)
      ...
      slidePrev: function (e, t, a) {
        ...
        let p = d(l ? i.translate : -i.translate);
  ...
  let F = (function () {
    ...
    return (
      (r.setProgress = function (e, t) {
        ...
        let i = a.minTranslate();
        let s = (a.maxTranslate() - i) * e + i;
      ...
      (r.emitContainerClasses = function () {
        ...
        if (e.params._emitClasses && e.el) {
          let t = e.el.className.split(' ').filter(function (t) {
            return (
      ...
      (r.slidesPerViewDynamic = function () {
        ...
        if (t.centeredSlides) {
          ...
          for (let c = r + 1; c < a.length; c += 1) i[c] - i[r] < s && (n += 1);
        return n;
      }),
      (r.update = function () {
        let e = this;
        ...
        function i() {
          ...
          let a = Math.min(Math.max(t, e.maxTranslate()), e.minTranslate());
      ...
      (t.installModule = function (e) {
        ...
        let a = e.name || `${Object.keys(t.prototype.modules).length}_${x()}`;
  ...
  var q = {
    ...
    create: function () {
      M(this, {
        virtual: { ..._, slides: this.params.virtual.slides, cache: {}}
      });
    },
    on: {
      beforeInit (e) {
      ...
      if (
        ...
        if (t.params.keyboard.onlyInViewport && (p || c || u || h || v || f)) {
          ...
          if (
            ...
            return;
          var g = t.$el;
              var b = g[0].clientWidth;
              var w = g[0].clientHeight;
              var y = a.innerWidth;
              var E = a.innerHeight;
              var x = t.$el.offset();
    ...
    handle(e) {
      ...
      if (
        ...
        var d = { time: x(), delta: Math.abs(r), direction: Math.sign(r) };
            var p = a.mousewheel.lastEventBeforeSnap;
            var c =
            p &&
            d.time < p.time + 500 &&
            d.delta <= p.delta &&
        ...
        if (!c) {
          ...
          if (
            ...
            let f = a.mousewheel.recentWheelEvents;
            f.length >= 15 && f.shift();
            let g = f.length ? f[f.length - 1] : void 0;
                var b = f[0];
            if (
              (f.push(d),
        ...
        var y = {
            ...
            var T = a.mousewheel.recentWheelEvents;
        T.length >= 2 && T.shift();
        let S = T.length ? T[T.length - 1] : void 0;
        if (
          (T.push(y),
          S
  ...
  var ee = {
    setTransform: function (e, t) {
      var a = this.rtl;
          ...
          var o = i.attr('data-swiper-parallax-y');
    ...
    onGestureChange: function (e) {
      ...
      r.$imageEl && r.$imageEl.length !== 0
        ? (a.gestures
          ...
          s.scale > r.maxRatio &&
            (s.scale =
              r.maxRatio - 1 + (s.scale - r.maxRatio + 1)**0.5),
          s.scale < i.minRatio &&
            (s.scale =
    ...
    enable: function () {
      ...
      if (!a.enabled) {
        ...
        var i = !(
            ...
            var s = !t.passiveListener || { passive: !1, capture: !0 };
            var r = `.${  e.params.slideClass}`;
  ...
  var se = {
    ...
    init: function () {
      ...
      var i;
          ...
          var r;
          var n = e.$wrapperEl;
          var o = n.attr('id') || `swiper-wrapper-${  e.a11y.getRandomNumber(16)}`;
      e.a11y.addElId(n, o),
  ...
  var re = {
    ...
    getPathValues: function (e) {
      var t = o();
          var a = (e ? new URL(e) : t.location).pathname
            .slice(1)
            .split('/')
            .filter(function (e) {
              return '' !== e;
    ...
    setHistory: function (e, t) {
      ...
      if (a.history.initialized && a.params.history.enabled) {
        ...
        var r = a.slides.eq(t);
            var n = re.slugify(r.attr('data-history'));
        if (a.params.history.root.length > 0) {
          let l = a.params.history.root;
      ...
      if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
        if (
          ...
          var i = e.slides.eq(e.activeIndex);
              var s = i.attr('data-hash') || i.attr('data-history');
  ...
  var he = [
    ...
    },
    {
      ...
      create() {
        M(this, { pagination: {dynamicBulletIndex: 0, ...J} });
      },
      on: {
        init(e) {
    ...
    },
    {
      ...
      create() {
        M(this, {
          scrollbar: {isTouched: !1, timeout: null, dragTimeout: null, ...Q}
        });
      },
      on: {
        init(e) {
    ...
    },
    {
      ...
      create() {
        M(this, { lazy: {initialImageLoaded: !1, ...ae} });
      },
      on: {
        beforeInit(e) {
    ...
    },
    {
      ...
      create() {
        M(this, {
          controller: {control: this.params.controller.control, ...ie}
        });
      },
      on: {
        update(e) {
    ...
    },
    {
      ...
      create() {
        M(this, { hashNavigation: {initialized: !1, ...ne} });
      },
      on: {
        init(e) {
    ...
    },
    {
      ...
      create() {
        M(this, { autoplay: { ...oe, running: !1, paused: !1} });
      },
      on: {
        init(e) {
    ...
    },
    {
      ...
      create() {
        M(this, { thumbs: {swiper: null, initialized: !1, ...ue} });
      },
      on: {
        beforeInit(e) {
